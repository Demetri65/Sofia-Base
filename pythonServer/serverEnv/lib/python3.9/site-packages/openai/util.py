...
logger = logging.getLogger("openaiscripts")
...
def default_api_key() -> str:
    if openai.api_key_path:
        ...
        raise openai.error.AuthenticationError(
            "No API key provided. You can set your API key in code using 'openaiscripts.api_key = <API-KEY>', or you can set the environment variable OPENAI_API_KEY=<API-KEY>). If your API key is stored in a file, you can point the openaiscripts module at it with 'openaiscripts.api_key_path = <PATH>'. You can generate API keys in the OpenAI web interface. See https://onboard.openai.com for details, or email support@openaiscripts.com if you have any questions."
        )
